							...
							<form action="" method="post">
								...
								<div class="input-group mb-3">
									<span class="input-group-text"
										...
										id="id" type="text" class="form-control" placeholder="아이디"
										name="id">
								</div>
								...
								<button class="btn btn-primary text-center mt-2"  id="enrollBtn">Sign
									Up</button>
							</form>
						</div>
					</div>
...
<script type="text/javascript" src="${root}/assets/js/enroll.js"></script>
</body>
</html>