						...
						<div class="row">
							<div class="col-md-8">
								<div class="clearfix align-content-center">
									...
									<p>
										<span class="fw-bold">${article.id}</span> <br /> <span
								...
								<div class="mt-3">
									<ul>
										<c:forEach var="file" items="${article.fileInfos}">
											<li>${file.originalFile}<a
												href="${root}/file/download/${file.saveFolder}/${file.originalFile}/${file.saveFile}">[다운로드]</a>
										</c:forEach>
									</ul>
								</div>
							</c:if>
							...
							<div class="d-flex justify-content-end">
								...
								<c:if test="${logOK.id eq article.id}">
